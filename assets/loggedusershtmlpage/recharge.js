...
function redirectToPayment(planId, price, validity, data, calls, message) {
                    ...
                    planCard.innerHTML = `
                        <div class="card p-4 shadow-sm border rounded-4 bg-white">
                            ...
                            <a href="#" class="btn text-white w-100 py-2 fw-bold rounded-5 mb-2" 
                                ...
                                onclick="redirectToPayment('${plan.planId}', ${plan.price}, '${plan.validity}', '${plan.data}', '${plan.calls}', '${plan.message}')">
